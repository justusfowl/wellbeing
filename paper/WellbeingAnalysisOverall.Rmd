...
rownames(df_modelsig) <- c("Age & Gender", "Alcohol", "Diseases", "Disability", "Health", "Medicines", "Mental Health", "Migration Status",  "Personal",  "Physical Activity","Protection Factors", "Qualtiy of Life", "Sight and Hearing", "Smoking", "SocioDemographics", "State", "Use", "Vaccinations", "None")
...
subsetgermancitizen_df1 %>%
  kable(booktabs = T, digits = 4) %>%
  kable_styling(bootstrap_options = c("striped", "hold_position"), full_width = F) %>%
  add_header_above(c(" ", "Citizenship Reponse" = 3, "Prop Response"= 3, "Proportion in   Level" = 3)) # %>%   save_kable("data/images/citizenship_population_table.png")
