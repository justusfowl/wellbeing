...
save_kable(t, "./analysis/charts/PSM_comparing_means.png")
...
write.csv(df_model_sumall, "./analysis/compareall3.csv")
```
...
df_model_sumd2 %>%
  kable(booktabs = T, digits = 4) %>%
  kable_styling(bootstrap_options = c("striped", "hold_position"), full_width = F) %>%   save_kable("./analysis/charts/agegenderexample.png")
