...
```{r}
#df_geda_LifeExp <- read_csv("data/df_geda_LifeExp.csv")
#df_meta_lvls <- read_csv("data/df_meta_lvls.csv")
#df_geda_de <- read_csv("data/df_geda_de.csv")
#df_overall <- read_csv("data/df_overall.csv")
#df_tmp <- read_csv("data/df_tmp.csv")
```
...
df_model_sumt %>%
  kable(booktabs = T, caption = "Training Data Table") %>%
...
df_model_sumd %>%
  kable(booktabs = T, caption = "Full Dataset Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position"))
#%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
...
df_model_sumall %>%
  kable(booktabs = T, caption = "Comparison of Training & Full Datasets") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")

#knit2html("WellbeingSubsetted.Rmd", output = NULL, envir = parent.frame(), text = NULL, quiet = FALSE,encoding = getOption("encoding"), force_v1 = TRUE)
```
...
df_modelsig <- reshape2::dcast(df_model_sumd, ThemeEn ~ Full_Sig)
...
df_modelsig <- df_modelsig %>% rename()

df_modelsig %>%
  kable(booktabs = T, caption = "Significance Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
...
```{r}
ggplot(df_modelsig, aes(fill=Condition, y=value, x=ThemeEn)) + 
...
#femtrainingRows <- sample(1:nrow(df_fem_base), 0.8 * nrow(df_fem_base))
#femtrainingData <- df_subset_female[femtrainingRows, ]
#femtestData <- df_subset_female[-femtrainingRows, ]
...
df_model_female %>%
  kable(booktabs = T, caption = "Female Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_male %>%
  kable(booktabs = T, caption = "Male Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_sumallsort$Full_logodds <- as.numeric(df_model_sumallsort$Full_logodds)
df_model_sumallsort <- df_model_sumallsort[order(-df_model_sumallsort$Full_logodds),]


df_model_sumallsort %>%
  kable(booktabs = T, caption = "Top 10 most likely to have a positive impact") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_sumallRevsort$Full_logodds <- as.numeric(df_model_sumallRevsort$Full_logodds)
df_model_sumallRevsort <- df_model_sumallRevsort[order(df_model_sumallRevsort$Full_logodds),]


df_model_sumallRevsort %>%
  kable(booktabs = T, caption = "Top 10 most likely to have a negative impact") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position"))
```


###Comparison of Male vs Female significant drivers
```{r}
...
df_model_genders <- df_model_genders %>% dplyr::select(c("coeff_label", "Male_value", "Female_value", "Male_Std.Error", "Female_Std.Error", "Male_T.Value", "Female_T.Value", "Male_p", "Female_p", "Male_Sig", "Female_Sig", "Male_logodds", "Female_logodds", "ThemeEn.x", "Varname.x", "VarLabelEn.x", "textLabelEn.x"))

colnames(df_model_genders) = c('coeff_label', 'Men', 'Women','Men', 'Women','Men', 'Women','Men', 'Women','Men', 'Women','Men','Women', 'ThemeEn', 'VarLabelEn', 'TextLabelEn')
df_model_genders %>%
  kable(booktabs = T, caption = "Significance difference between men and women") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) %>%
  add_header_above(c(" ", "Value" = 2, "Std.Error"= 2, "T.value"= 2, "p-value"= 2, "Significant"= 2, "Logodds"= 2, " " =4)) #%>%
...
df_model_subsetAgeGender %>%
  kable(booktabs = T, caption = "Age and Gender Significance") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetGender_df1 %>%
  ...
  kable_styling(bootstrap_options = c("striped", "hold_position")) %>%
  add_header_above(c(" ", "Population" = 2, "Population Proportion"= 2, "Proportion Well-being Cat" = 2)) #%>%
  #add_footnote("footnote")
```
...
df_model_subsetAlcohol %>%
  kable(booktabs = T, caption = "Figure XX. Alcohol Frequency Consumed Significance Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
...
```{r}
#alcohol subsets
df_subset_AlcoholDaily <- filter(df_subsetall3, AKoft12_k == "1")
df_subset_AlcoholWeekly <- filter(df_subsetall3, AKoft12_k == "2")
df_subset_AlcoholMonthly <- filter(df_subsetall3, AKoft12_k == "5")
df_subset_AlcoholLessMonthly <- filter(df_subsetall3, AKoft12_k == "7")
df_subset_AlcoholNoMore <- filter(df_subsetall3, AKoft12_k == "8")
df_subset_AlcoholNone <- filter(df_subsetall3, AKoft12_k == "9")
df_subset_AlcoholDaily <- df_subset_AlcoholDaily %>% dplyr::select(-AKoft12_k)
df_subset_AlcoholWeekly <- df_subset_AlcoholWeekly %>% dplyr::select(-AKoft12_k)
df_subset_AlcoholMonthly <- df_subset_AlcoholMonthly %>% dplyr::select(-AKoft12_k)
df_subset_AlcoholLessMonthly <- df_subset_AlcoholLessMonthly %>% dplyr::select(-AKoft12_k)
df_subset_AlcoholNoMore <- df_subset_AlcoholNoMore %>% dplyr::select(-AKoft12_k)
df_subset_AlcoholNone <- df_subset_AlcoholNone %>% dplyr::select(-AKoft12_k)
...
subsetAlcohol_df1 %>%
  kable(booktabs = T, caption = "Alcohol Population Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
...
df_model_subsetDisease %>%
  kable(booktabs = T, caption = "Disease Significance Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetIBD_df1 %>%
  kable(booktabs = T, caption = "Irritable Bowel Syndrome Population Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetCirrhosis_df1$propNo <- subsetCirrhosis_df1[,3]/sum(subsetCirrhosis_df1[,3] +subsetCirrhosis_df1[,2])

subsetCirrhosis_df1 <- subsetCirrhosis_df1 %>% rename(Yes = `1`, No = `2`)

subsetCirrhosis_df1 %>%
  kable(booktabs = T, caption = "Cirrhosis population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
```{r}
describe(df_subsetall3$KHkarz12)
```
...
subsetCancer_df1 %>%
  kable(booktabs = T, caption = "Cancer population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetHeartfailure_df1 %>%
  kable(booktabs = T, caption = "Heart failure population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetHighBPthisyear_df1 %>%
  kable(booktabs = T, caption = "Training Table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")

subsetHighBPever_df1 %>%
  kable(booktabs = T, caption = "Ever diagnosed with high blood pressure population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetdiabetes_df1 %>%
  kable(booktabs = T, caption = "Diabetes population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_subsetDisability %>%
  kable(booktabs = T, caption = "Fig XX: Disability significance table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
...
subsetLowerBack12mos_df1 %>%
  kable(booktabs = T, caption = "Lower back population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetNeckSpine12mos_df1 %>%
  kable(booktabs = T, caption = "Neck & spine population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetOfficialDisable_df1 %>%
  kable(booktabs = T, caption = "Officially disable population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_subsetHealth %>%
  kable(booktabs = T, caption = "Fig XX: Health focus and limitations significance table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetChronicDiseases_df1 %>%
  kable(booktabs = T, caption = "Chronic disease population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetChronicDiseases_df2$propStrongly <- subsetChronicDiseases_df2[,2]/sum(subsetChronicDiseases_df2[,2])
subsetChronicDiseases_df2$propModerately <- subsetChronicDiseases_df2[,3]/sum(subsetChronicDiseases_df2[,3])
subsetChronicDiseases_df2$propNotlimited <- subsetChronicDiseases_df2[,4]/sum(subsetChronicDiseases_df2[,4])
...
subsetChronicDiseases_df2 %>%
  kable(booktabs = T, caption = "Fig XX. Restricted/limited population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_subsetMedicines %>%
  kable(booktabs = T, caption = "Medication Significane") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetTakingmeds_df1 %>%
  kable(booktabs = T, caption = "Taking medication population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
subsetTakingmeds_df2$propYes <- subsetTakingmeds_df1[,2]/sum(subsetTakingmeds_df1[,2])
subsetTakingmeds_df2$propNo <- subsetTakingmeds_df1[,3]/sum(subsetTakingmeds_df1[,3])
subsetTakingmeds_df2 <- subsetTakingmeds_df2 %>% rename(Yes = `1`, No = `2`)

subsetTakingmeds_df2 %>%
  kable(booktabs = T, caption = "Taking medications 2 population table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_subsetMentalHealth %>%
  kable(booktabs = T, caption = "Mental health significance table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
df_model_subsetMigration %>%
  kable(booktabs = T, caption = "Birthplace and citizenship significance table") %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
...
```{r}
#where born subsets
df_subset_germanborn <- filter(df_subsetall3, MIbirthplace == "10")
df_subset_EUborn <- filter(df_subsetall3, MIbirthplace == "21")
df_subset_nonEUborn <- filter(df_subsetall3, MIbirthplace == "22")
...
subsetgermanborn_df1 %>%
  kable(booktabs = T, caption = "Fig XX: Birthplace population table", digits = 4) %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) %>%
  add_header_above(c(" ", "Population" = 3, "Population Proportion"= 3, "Proportion Well-being Cat" = 3)) #%>%
  #add_footnote("footnote")
```
...
```{r}
#citizen subsets
#df_subset_germancitizen <- filter(df_subsetall3, MIcitizen == "10")
#df_subset_EUcitizen <- filter(df_subsetall3, MIcitizen == "21")
#df_subset_nonEUcitizen <- filter(df_subsetall3, MIcitizen == "22")
...
subsetgermancitizen_df1 %>%
  kable(booktabs = T, caption = "Fig XX:Citizenship population table", digits = 4) %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) %>%
  add_header_above(c(" ", "Population" = 3, "Population Proportion"= 3, "Proportion Well-being Cat" = 3)) #%>%
  #add_footnote("footnote")
...
##Personal theme that include household structure and BMI
```{r}
...
df_model_subsetSeeandHear %>%
  kable(booktabs = T, caption = "Sighte & hearing significance table", digits = 4) %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) %>%
  add_header_above(c(" ", "Population" = 6, "Population Proportion"= 6, "Proportion Well-being Cat" = 6)) #%>%
  #add_footnote("footnote")
#subsethousehold_df1$
...
df_model_subsetSmoking %>%
  kable(booktabs = T, caption = "Fig XX: Smoking significance table", digits = 4) %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Population" = 6, "Population Proportion"= 6, "Proportion Well-being Cat" = 6)) #%>%
  #add_footnote("footnote")
#subsethousehold_df1$
...
subsetemployment_df1 <- reshape2::dcast(df_subsetall3, GZmehm1 ~ SDaeqeink_k)
subsetemployment_df1$WBemployed <- subsetemployment_df1[,2]/sum(subsetemployment_df1[,2])
subsetemployment_df1$WBunemployed <- subsetemployment_df1[,3]/sum(subsetemployment_df1[,3])
subsetemployment_df1$student <- subsetemployment_df1[,4]/sum(subsetemployment_df1[,4])
subsetemployment_df1$WBretired <- subsetemployment_df1[,5]/sum(subsetemployment_df1[,5])
subsetemployment_df1$WBunabletoacquire <- subsetemployment_df1[,6]/sum(subsetemployment_df1[,6])
subsetemployment_df1$WBmilcivservice <- subsetemployment_df1[,7]/sum(subsetemployment_df1[,7])
subsetemployment_df1$WBhouse <-  subsetemployment_df1[,8]/sum(subsetemployment_df1[,8])
subsetemployment_df1$WBmoveinactive <- subsetemployment_df1[,9]/sum(subsetemployment_df1[,9])

subsetemployment_df1$employed <- subsetemployment_df1[,2]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
subsetemployment_df1$unemployed <- subsetemployment_df1[,3]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
subsetemployment_df1$student <- subsetemployment_df1[,4]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
subsetemployment_df1$retired <- subsetemployment_df1[,5]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
subsetemployment_df1$unabletoacquire <- subsetemployment_df1[,5]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
subsetemployment_df1$milcivservice <- subsetemployment_df1[,5]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
subsetemployment_df1$house <- subsetemployment_df1[,5]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
subsetemployment_df1$moveinactive <- subsetemployment_df1[,5]/(subsetemployment_df1[,2] + subsetemployment_df1[,3] + subsetemployment_df1[,4] + subsetemployment_df1[,5] + subsetemployment_df1[,6] + subsetemployment_df1[,7] + subsetemployment_df1[,8] + subsetemployment_df1[,9])
...
#subsetemployment_df1 %>%
#  kable(booktabs = T, caption = "Employment status/type population table", digits = 4) %>%
#  kable_styling(bootstrap_options = c("striped", "hold_position")) %>%
#  add_header_above(c(" ", "Population" = 8, "Population Proportion"= 8, "Proportion Well-being Cat" = 8)) #%>%
  #add_footnote("footnote")
subsetemployment_df1
```
...
```{r}
#Viewing the significance of various aspects of TYPE OF HEALTH INSURANCE AND PRIOR MEDICAL TTEST RESULTS, which are or are not significant
...
subsetbloodfat12_df2$propYes <- subsetbloodfat12_df2[,2]/sum(subsetbloodfat12_df2[,2])
subsetbloodfat12_df2$propNo <- subsetbloodfat12_df2[,3]/sum(subsetbloodfat12_df2[,3])
```
