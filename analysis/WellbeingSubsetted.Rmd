...
```
```{r}
#setwd("C:/Users/jerim/Dropbox/GitHub/wellbeing/analysis")
getwd()
```
...
df_modelsig %>%
  ...
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
#write.csv(df_modelsig, "data/modelsig.csv")
```
...
df_model_subsetAlcohol %>%
  kable(booktabs = T, caption = "Figure XX. Alcohol Frequency Consumed Significance Table", digits = 4) %>%
  kable_styling(bootstrap_options = c("striped", "hold_position")) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
...
df_model_subsetHealth %>%
  ...
  kable_styling(bootstrap_options = c("striped", "hold_position", digits = 4)) #%>%
  #add_header_above(c(" ", "Training" = 2, "Training2"= 2, "Training3"= 2, " " =4)) %>%
  #add_footnote("footnote")
```
