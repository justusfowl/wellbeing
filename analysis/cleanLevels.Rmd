      ...
      for (l in unique_lvls){
        ...
        if (!is.na(l)){
          ...
          if (nrow(col_meta[col_meta$textLevel == l,]) > 0){
            ...
            df_geda_num[[i]][df_geda_num[[i]] == l] <- col_meta[col_meta$textLevel == l,]$numLevel
...
# heav_dta <- read_dta("data/GEDA14.dta")
# labelled::val_labels(heav_dta$sex)
```
